...
def page_tour_elemento_inicio_processo():
    # st.title("Início do processo")
    st.markdown(HOME_CSS, unsafe_allow_html=True)
    st.markdown("<h1 class='centered-title'>Início do processo</h1>", unsafe_allow_html=True)
    ...
    with info_texto:
        ...
        with open('template_matching/texto_elemento_inicio_tour.txt', 'r', encoding='utf-8') as file:
                data = file.read()
