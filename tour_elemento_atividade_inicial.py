...
def page_tour_elemento_atividade_inicial():
    # st.title("Atividade inicial")
    st.markdown(HOME_CSS, unsafe_allow_html=True)
    st.markdown("<h1 class='centered-title'>Atividade inicial</h1>", unsafe_allow_html=True)
    ...
    with info_texto:
        ...
        with open('template_matching/texto_elemento_atividade_inicial_tour.txt', 'r', encoding='utf-8') as file:
                data = file.read()
