...
def page_tour_elemento_loop():
    # st.title("Loop")
    st.markdown(HOME_CSS, unsafe_allow_html=True)
    st.markdown("<h1 class='centered-title'>Loop</h1>", unsafe_allow_html=True)
    ...
    with info_texto:
        ...
        with open('template_matching/texto_elemento_loop_tour.txt', 'r', encoding='utf-8') as file:
                data = file.read()
