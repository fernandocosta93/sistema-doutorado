def variaveis_necessarias(nome_processo):
    ...
    texto_seta_transicao = 'template_matching/navegar_seta_transicao.txt'
    ...
    if nome_processo == "ANVISA":
        ...
        img_atividade = 'imgs/tjsp/atividade.png'
        texto_atividade = 'template_matching/tjsp/texto_atividades.txt'
        img_atividade_inicial = 'imgs/tjsp/atividade_inicial.png'
        texto_atividade_inicial = 'template_matching/tjsp/texto_atividades_iniciais.txt'
        img_atividade_final = 'imgs/tjsp/atividade_final.png'
        texto_atividade_final = 'template_matching/tjsp/texto_atividades_finais.txt'
        img_transicao_atividades = 'imgs/tjsp/transicao_atividades.png'
        texto_transicao_atividade = 'template_matching/tjsp/navegar_transicao_atividades.txt'
        img_autotransicao = 'imgs/tjsp/auto_transicao.png'
        texto_autotransicao = 'template_matching/tjsp/navegar_auto_transicao.txt'
        img_transicao_loop = 'imgs/tjsp/transicao_loop.png'
        texto_transicao_loop = 'template_matching/tjsp/navegar_transicao_loop.txt'
